...
public class SafetyService {
	...
	public String requestHospitalApi() throws IOException {
		...
		// 2. URL객체를 이용해서 HttpURLConnection 생성
	...
	public String getInfo() {
		final String SERVICE_KEY = "123123";
		
		StringBuilder sb = new StringBuilder();
		sb.append("https://apis.data.go.kr/B552584/EvCharger/getChargerInfo");
		sb.append("?serviceKey="+ SERVICE_KEY);
	...
	public String getItems(String query) {
		// 네이버 검색 API 예제 - 블로그 검	    
        String clientId = "adadf"; //애플리케이션 클라이언트 아이디
        String clientSecret = "asdfasf"; //애플리케이션 클라이언트 시크릿
